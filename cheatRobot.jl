...
#функции от обычного робота



mutable struct CheatRobot <:AbstractRobot
    robot::Robot
    coords::NTuple{2,Integer}

    CheatRobot(robot::Robot, coords::NTuple{2,Integer}) = new( robot, (0,0) )

    function move!(r::CheatRobot, side::HorizonSide)
